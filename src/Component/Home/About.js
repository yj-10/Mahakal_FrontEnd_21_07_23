              ...
              <div className="about_details_wrap">
                <div className="about_details_title">
                  <h3 className="h3_title">
                    OVER <span>20+ YEARS</span> OF TRUST AND EXCELLENCE
                  </h3>
                  <p className="pera">
                    Established in the Year of 2002, Mahakal Cooling Towers is
                    the leading Manufacturer, Wholesaler, and Trader of Cooling
                    Towers and Cooling Tower parts.
                  </p>
                  <figure className="about_img_wrap">
                    <Image src={aboutImg} alt="about_img" fluid />
                    <div className="about_img_btn_wrap">
                      <button className="btn about_img_btn">
                        {" "}
                        <a href={Mahakal} download>
