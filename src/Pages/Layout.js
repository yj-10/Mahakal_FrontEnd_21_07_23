            ...
            <div className="header_contact_phone">
              <div className="header_contact_email">
                <p className="pera">
                  {" "}
                  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                  <AiOutlineMail /> mahakalcoolingtowers@gmail.com
                </p>
              </div>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="ms-auto">
                ...
                <Nav.Link id="basic-nav-dropdown">
                  <Link to={"/product"}>
                    Products <IoIosArrowDown style={{ fontSize: "10px" }} />{" "}
                  </Link>
                  <ul className="ul">
                    <li>
                ...
                <Nav.Link id="basic-nav-dropdown">
                  <Link to={"/Service"}>
                    Services <IoIosArrowDown style={{ fontSize: "10px" }} />
                  </Link>
                ...
                <Nav.Link href="#link">
                  <Link to={"/Laboratery"}>R&D Laboratory</Link>
                </Nav.Link>
                <Nav.Link href="#link">
